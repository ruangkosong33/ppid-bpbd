...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active"><a href="{{ route('notulen.index') }}">Notulen</a></li>
            ...
            <form action="{{route('notulen.update', $notulen->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <x-card>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $notulen->file }}" readonly>
                    </div>
