...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">File Produk Hukum</li>
@endsection
    ...
    <section class="project-details-area pt-50 pb-120">
        <div class="container">
            ...
            <div class="section-title-two text-center mb-50">
                <span class="sub-title">{{$detailHukums->title}}</span>
            </div>
            ...
            <div class="rts-service-details-area rts-section-gap">
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="service-details-card">
                                            <div class="details">
                                                <h6 class="title">Tentang</h6>
                                                    <p class="disc">{{$detailHukums->title}}</p><br>
                                                <h6 class="title">Tanggal Di Tetapkan</h6>
                                                    <p class="disc">{{ date('d-m-Y', strtotime($detailHukums->date)) }}</p><br>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-8">
                            @if ($detailHukums->file)
                                <div id="pdfViewer">
                                    <embed src="{{ asset('storage/file-hukum/' . $detailHukums->file) }}" type="application/pdf" width="100%" height="800px">
                                </div>
                                <div class="title text-center" id="viewerOption">
                                    ...
                                    <br>
                                    <a class="btn btn-three" style="margin-top: 15px;" href="{{ asset('storage/file-hukum/' . $detailHukums->file) }}">Download File</a>
                                </div>                 
                            @else
                                Tidak ada File
                            @endif
