...
@section('title', 'Detail DIP File Kategori Berkala')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{route('beranda')}}">Beranda</a></li>
    <li class="breadcrumb-item">Informasi Publik</li>
    <li class="breadcrumb-item"><a href="{{route('berkala')}}">Kategori Berkala</a></li>
    <li class="breadcrumb-item active" aria-current="page">File DIP Kategori Berkala</li>
@endsection
    ...
    <section class="project-details-area pt-50 pb-120">
        <div class="container">
            ...
            <div class="section-title-two text-center mb-50">
                <span class="sub-title">{{$berkalas->title}}</span>
            </div>
                ...
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="service-details-card">
                                            <div class="details">
                                                <h6 class="title">Judul File</h6>
                                                    <p class="disc">{{$berkalas->title}}</p><br>
                        ...
                        <div class="col-md-8">
                            @if ($berkalas->file)
                                <div id="pdfViewer">
                                    <embed src="{{ asset('storage/file-dip/' . $berkalas->file) }}" type="application/pdf" width="100%" height="800px">
                                </div>
                                <div class="title text-center" id="viewerOption">
                                    ...
                                    <br>
                                    <a class="btn btn-three" style="margin-top: 15px;" href="{{ asset('storage/file-dip/' . $berkalas->file) }}">Download File</a>
                                </div>                 
                            @else
                                Tidak ada File
                            @endif
