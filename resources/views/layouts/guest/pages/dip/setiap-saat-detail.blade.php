...
@section('title', 'Detail DIP File Kategori Setiap Saat')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{route('beranda')}}">Beranda</a></li>
    <li class="breadcrumb-item">Informasi Publik</li>
    <li class="breadcrumb-item"><a href="{{route('setiapsaat')}}">Kategori Setiap Saat</a></li>
    <li class="breadcrumb-item active" aria-current="page">File DIP Kategori Setiap Saat</li>
@endsection
    ...
    <section class="project-details-area pt-50 pb-120">
        <div class="container">
            ...
            <div class="section-title-two text-center mb-50">
                <span class="sub-title">{{$setiapsaats->title}}</span>
            </div>
                ...
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="service-details-card">
                                            <div class="details">
                                                <h6 class="title">Judul File</h6>
                                                    <p class="disc">{{$setiapsaats->title}}</p><br>
                        ...
                        <div class="col-md-8">
                            @if ($setiapsaats->file)
                                <div id="pdfViewer">
                                    <embed src="{{ asset('storage/file-dip/' . $setiapsaats->file) }}" type="application/pdf" width="100%" height="800px">
                                </div>
                                <div class="title text-center" id="viewerOption">
                                    ...
                                    <br>
                                    <a class="btn btn-three" style="margin-top: 15px;" href="{{ asset('storage/file-dip/' . $setiapsaats->file) }}">Download File</a>
                                </div>                 
                            @else
                                Tidak ada File
                            @endif
