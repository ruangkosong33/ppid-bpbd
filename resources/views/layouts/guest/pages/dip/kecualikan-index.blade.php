...
@section('title', 'DIP Kategori Informasi Di Kecualikan')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{route('beranda')}}">Beranda</a></li>
    <li class="breadcrumb-item">Informasi Publik</li>
    <li class="breadcrumb-item active" aria-current="page">Kategori Di Kecualikan</li>
@endsection
    ...
    <section class="project-details-area pt-50 pb-120">
        <div class="container">
            ...
            <div class="section-title-two text-center mb-50">
                <span class="sub-title">Daftar Informasi Di Kecualikan</span>
            </div>
                        ...
                        <div class="col-md-11">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($kecualikan as $key=>$k)
                                        <tr>
                                            <td class="text-center">{{ $key+1 }}</td>
                                            <td class="text-center">{{ $k->title }}</td>
                                            {{-- <td class="text-center">{{ date('d-m-Y', strtotime($k->date)) }}</td> --}}
                                            <td class="text-center"><a href="{{ route('kecualikan.detail', $k->slug) }}" class="btn btn-info btn-sm">Lihat</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
