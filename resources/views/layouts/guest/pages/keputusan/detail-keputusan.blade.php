                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            @if ($item->file)
                                <div id="pdfViewer">
                                    <embed src="{{ asset('storage/file-keputusan/' . $item->file) }}" type="application/pdf" width="100%" height="800px">
                                </div>
                                <div class="title text-center" id="viewerOption">
                                    ...
                                    <br>
                                    <a class="btn btn-three" style="margin-top: 15px;" href="{{ asset('storage/file-keputusan/' . $item->file) }}">Download File</a>
                                </div>                 
                            @else
                                Tidak ada File
                            @endif
