                ...
                <div class="row align-items-center">
                        <div class="col-lg-6 col-md-8">
                            <div class="section-title-two mb-60 tg-heading-subheading animation-style3">
                                ...
                                <h6 class="title tg-element-title">Media Infogragis Kami</h6>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-4">
                            <div class="view-all-btn text-end mb-30">
                                <a href="{{route('semua.graphics')}}" class="btn">Lihat Semua</a>
                            </div>
                        </div>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item-two">
                                ...
                                <div class="services-content-two">
                                    ...
                                    <h2 class="title"><a href="{{route('detail.graphics', $item->slug)}}">{{$item->title}}</a></h2>
